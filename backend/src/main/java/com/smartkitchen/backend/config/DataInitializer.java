    ...
    public void run(String... args) {
        if (menuItemRepository.count() == 0) {
            menuItemRepository.saveAll(Arrays.asList(
                ...
                new MenuItem("Supreme Garlic Bread", "Crispy bread baked with garlic butter, herbs, and mozzarella cheese", new BigDecimal("99"), "Garlic Bread", true, 10, 3, 10, "SupremeGarlicBread.png", true, 1L),
                new MenuItem("Cheese Corn Garlic Bread", "Garlic bread topped with sweet corn, mozzarella cheese, and butter", new BigDecimal("79"), "Garlic Bread", true, 10, 3, 10, "CheeseCornGarlicBread.png", true, 1L),
                new MenuItem("Cheese Jalapeño Garlic Bread", "Loaded with mozzarella cheese, jalapeños, garlic butter, and herbs", new BigDecimal("89"), "Garlic Bread", true, 10, 3, 10, "CheeseJalapenoGarlicBread.jpeg", true, 1L),
                new MenuItem("Cheese Paneer Garlic Bread", "Stuffed with paneer, mozzarella cheese, garlic butter, and spices", new BigDecimal("109"), "Garlic Bread", true, 10, 3, 10, "CheesePaneerGarlicBread.png", true, 1L),
                ...
                new MenuItem("Chocolate Sandwich", "Sweet sandwich made with chocolate spread and soft bread", new BigDecimal("49"), "Sandwich", true, 8, 2, 8, "ChocolateSandwich.jpeg", true, 1L),
